...
public class AlumnoMateriasController {
    ...
    public static void init() {
        ...
        get("/alumno/inscripcion-materia", (req, res) -> {
            ...
            // 3. Traer materias del plan en las que el alumno NO esté ya inscripto (ni cursando ni aprobadas)
            ...
            for (Map mat : materiasCandidatas) {
                ...
                for (Map reqCorr : requeridas) {
                    ...
                    // Verificamos si la correlativa está aprobada (en inscripcion con estado 'Aprobada')
                    long aprobada = Base.count("inscripcion", "alumno_id = ? AND materia_id = ? AND estado = 'Aprobada'", 
        ...
        post("/alumno/procesar-inscripcion", (req, res) -> {
            ...
            try {
                ...
                res.redirect("/alumno/inscripcion-materia?message=Inscripcion+realizada+con+exito.+Espera+confirmacion.");
            } catch (Exception e) {
        ...
        get("/alumno/cursando", (req, res) -> {
            ...
            // Traer las inscripciones que NO sean "Aprobada" o "Regularizada" (es decir, que esté cursando o pendiente)
